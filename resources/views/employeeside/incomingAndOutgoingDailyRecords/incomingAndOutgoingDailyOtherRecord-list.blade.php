...
<body>
    <div class="container mt-2">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('searchOperationDataIncomingAndOutgoingDataDailyRecord') }}" method="post"
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right"
                                                                ...
                                                                @if (!empty($selectIncomingAndOutgoingDailyRecords->item_outgoing_date))
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('pageDetailIncomingAndOutgoingDataDailyRecordPage', $selectIncomingAndOutgoingDailyRecords->id) }}"><i
                                                                            class="fas fa-user mx-2"></i> View
                                                                        Detail</a>
                                                                @else
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('pageEditIncomingAndOutgoingDataDailyRecordPage', $selectIncomingAndOutgoingDailyRecords->id) }}"><i
                ...
                <div class="modal-body">
                    <div class="row d-flex justify-content-center align-items-center">
                        <div class="col-5 p-2 mx-1">
                            <a href="{{ route('newCreatePageDisposibleIncomingAndOutgoingDaily') }}"
                                class="btn btn-outline-primary">Incoming Record For Disposible</a>
                        </div>
                        <div class="col-5 p-2 mx-1">
                            <a href="{{ route('newCreateDataIncomingAndOutgoingDailyCreatingPage') }}"
