...
<body>
    <div class="container mt-2">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('filterSystemAccordingIncomingAndOutgoing') }}" method="post"
                ...
                <div class="col-12 py-2">
                    ...
                    {{-- @else
                                                                            <a class="dropdown-item"
                                                                                href="{{ route('editIncomingAndOutGoingDailyRecordPage', $selectIncomingAndOutgoingDailyRecords->id) }}"><i
                                                                                    class="fas fa-edit mx-2"></i>
                                                                                Edit</a>
                                                                        @endif
                                                                    @else
                                                                        <a class="dropdown-item"
                                                                            href="{{ route('withoutTjfOutgoingInspectionCreatingPage', $selectIncomingAndOutgoingDailyRecords->incoming_report_ids) }}"><i
