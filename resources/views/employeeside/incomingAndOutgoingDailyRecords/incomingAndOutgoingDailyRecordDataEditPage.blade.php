            ...
            <div class="card-body">
                ...
                @else
                    ...
                    @if (empty($selectIncomingAndOutgoingDataDailyRecords->item_model))
                        <form
                            action="{{ route('pageUpdateOperationIncomingAndOutgoingDisposibleDailyRecord', $selectIncomingAndOutgoingDataDailyRecords->id) }}"
                    ...
                    @else
                        <form
                            action="{{ route('pageUpdateOperationIncomingAndOutgoingDataDailyRecord', $selectIncomingAndOutgoingDataDailyRecords->id) }}"
                            method="post" class="row" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="col-md-10 py-2 px-2">
