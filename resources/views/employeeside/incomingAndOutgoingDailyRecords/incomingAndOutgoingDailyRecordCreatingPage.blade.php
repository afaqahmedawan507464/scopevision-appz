    ...
    <div class="container mt-2">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('createNewOperationIncomingAndOutgoingDailyRecord') }}" method="post"
                            ...
                            <div class="col-12">
                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                    <input type="text" class="form-control" placeholder="Ex, gif-140"
                                        ...
                                        value="{{ $incomingInsppectionFormDatass->id }}">
                                </div>
                            </div>
                            {{--  --}}
                            <div class="col-12">
                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                    ...
                                    <input type="date" class="form-control" placeholder="Ex, 12-12-2023"
                                        ...
                                        value="{{ $incomingInsppectionFormDatass->scope_incoming_date }}">
                                </div>
                            </div>
                            {{--  --}}
                            <div class="col-12">
                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                    ...
                                    <label class="lable2 text-start mx-2 mt-1  d-md-none " for="">Scope Model
                                        :</label>
                                    <input type="text" class="form-control" placeholder="Ex, gif-140"
                                        name="scopeModel" value="{{ $incomingInsppectionFormDatass->scope_model }}">
                                </div>
                            </div>
                            {{--  --}}
                            <div class="col-12">
                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                    ...
                                    <input type="number" class="form-control" placeholder="Ex, 123456789"
                                        name="scopeSrNumber"
                                        value="{{ $incomingInsppectionFormDatass->scope_sr_number }}">
                                </div>
                            </div>
                            {{--  --}}
                            <div class="col-12">
                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                    ...
                                    <input type="text" class="form-control" placeholder="Ex, Demo Person"
                                        ...
                                        value="{{ $incomingInsppectionFormDatass->sender_name }}">
                                </div>
                            </div>
                            {{--  --}}
                            <div class="col-12">
