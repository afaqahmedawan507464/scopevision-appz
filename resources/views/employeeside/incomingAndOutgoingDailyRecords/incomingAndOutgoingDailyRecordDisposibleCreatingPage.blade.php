...
<body>
    <div class="container mt-2">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <h4 class="text-end d-none d-md-block">Incoming And Outgoing Daily Record(Disposible)</h4>
                <h6 class="text-center d-md-none ">Incoming And Outgoing Daily Record(Disposible)</h6>
                <form action="{{ route('newCreateOperationIncomingAndOutgoingDisposibleDailyRecord') }}" method="post"
