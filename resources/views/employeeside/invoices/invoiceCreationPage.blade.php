        ...
        <div class="card">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('createOperationInvoiceRepairingOperation') }}" method="post" class="row" enctype="multipart/form-data">
                        @csrf
                    ...
                    @else
                    <form action="{{ route('createOperationInvoiceDisposibleOperation') }}" method="post" class="row" enctype="multipart/form-data">
                        @csrf
                        <div class="row px-2 py-2">
                            <div class="col-12">
                                <div class="d-flex justify-content-center align-items-center py-2">
                    ...
                    @endif   
                    @else
                    <form action="{{ route('createOperationInvoiceRepairing_Operation') }}" method="post" class="row" enctype="multipart/form-data">
                        @csrf
                        <div class="col-10 py-2 px-2">
                            {{--  --}}
                            <h4>Invoice Basic Information</h4>
