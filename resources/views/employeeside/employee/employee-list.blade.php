            ...
            <div class="card-body">
                ...
                <div class="col-12 py-2">
                    <div class="py-2 d-flex justify-content-end align-items-center">
                        <a href="{{ route('newEmployeeCreatePage') }}" class="btn btn-outline-primary "><i
                                            ...
                                            <div class="col-12" style="padding-left: 90%;">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" style="">
                                                    <a class="dropdown-item"
                                                        href="{{ route('employeeDetailsPage', $selectEmployees->id) }}"><i
                                                            class="fas fa-user mx-2"></i> View Detail</a>
                                                    <a class="dropdown-item"
                                                        href="{{ route('attendanceEmployeesDetailsPage', $selectEmployees->id) }}"><i
