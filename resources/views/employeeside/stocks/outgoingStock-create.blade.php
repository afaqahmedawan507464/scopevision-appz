        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @else
                    ...
                    @endforeach
                    <form action="{{ route('outgoingOperationDisposibleItem') }}" method="post" class="row"
                                ...
                                <div class="col-12 d-none">
                                    <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                        ...
                                        <input type="text" class="form-control" placeholder="Ex, 2mm" name="itemQtv"
                                            value="{{ $selectInvoiceDataas->invoice_item_disposible_qtv }}">
                                    </div>
                                </div>
                                {{-- @endforeach --}}
                                {{--  --}}
                                <div class="col-12 d-none">
                                    <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                        ...
                                        <input type="text" class="form-control" placeholder="Ex, 2mm"
                                            name="itemInvoiceId" value="{{ $selectInvoiceDataas->id }}">
                                    </div>
                                </div>
                                {{--  --}}
                                <div class="col-12">
                                    <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                        ...
                                        <input type="date" class="form-control" placeholder="Ex, 2mm"
                                            name="itemOutgoingDate" value="{{ $selectInvoiceDataas->invoice_date }}">
                                    </div>
                                </div>
                                {{--  --}}
                            </div>
