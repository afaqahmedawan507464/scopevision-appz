...
<body>
    <div class="container mt-2">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <h2 class="text-end d-none d-md-block">Create A New Stock ( Parts )</h2>
                <h4 class="text-center d-md-none ">Create A New Stock ( Parts )</h4>
                <form action="{{ route('newStockScopesPartsOperation') }}" method="post" class="row"
                            ...
                            <div class="col-12">
                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                    ...
                                    <textarea name="itemDescription" id="itemDescription" cols="30" rows="3" class="form-control"
                                        placeholder="Ex, demo items"></textarea>
                                </div>
                            </div>
                            {{--  --}}
                            <div class="col-12">
