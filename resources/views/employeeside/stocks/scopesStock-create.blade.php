...
<body>
    <div class="container mt-2">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <h2 class="text-end d-none d-md-block">Create A New Stock ( Scopes )</h2>
                <h4 class="text-center d-md-none ">Create A New Stock ( Scopes )</h4>
                @if ($selectInspectionReport->isEmpty())
                @else
                    @foreach ($selectInspectionReport as $selectInspectionReports)
                    @endforeach
                    <form action="{{ route('newStockScopesOperation') }}" method="post" class="row"
                            ...
                            <div class="row px-2 py-2">
                                <div class="col-12">
                                    <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                        ...
                                        <input type="text" class="form-control" placeholder="Ex, Scope"
                                            name="itemDetails" value="{{ $selectInspectionReports->scope_model }}">
                                    </div>
                                </div>
                                {{--  --}}
                                <div class="col-12 d-none">
                                    <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                        ...
                                        <label class="lable2 text-start mx-2 mt-1  d-md-none " for="">Date
                                            :</label>
                                        <label class="text-end mx-2 mt-1" for="" style="width:300px;">Inspection
                                            Id:</label>
                                        <input type="text" class="form-control" placeholder="Ex, 123465"
                                            name="inspectionId" value="{{ $selectInspectionReports->id }}">
                                    </div>
                                </div>
                                {{--  --}}
                                <div class="col-12">
                                    <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                        ...
                                        <label class="lable2 text-start mx-2 mt-1  d-md-none " for="">Price Per
                                            Unit
                                            :</label>
                                        <input type="text" class="form-control" placeholder="Ex, 123465"
                                ...
                                <div class="col-12">
                                    <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                        ...
                                        <input type="text" class="form-control" placeholder="Ex, 12345678"
                                            name="itemSerialNo"
                                            value="{{ $selectInspectionReports->scope_sr_number }}">
                                    </div>
                                </div>
                                {{--  --}}
                                <div class="col-12">
                                    <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                        ...
                                        <input type="text" class="form-control" placeholder="Ex, cf-140L"
                                            name="itemModel" value="{{ $selectInspectionReports->scope_model }}">
                                    </div>
                                </div>
                                {{--  --}}
                                <div class="col-12">
                                    <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                        ...
                                        <input type="date" class="form-control" placeholder="Ex, 0000-00-00"
                                            ...
                                            value="{{ $selectInspectionReports->scope_incoming_date }}">
                                    </div>
                                </div>
                                {{--  --}}
                                {{--  --}}
                                ...
                                <div class="col-12">
                                    <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                        ...
                                        <label class="lable2 text-start mx-2 mt-1  d-md-none " for="">Total
                                            Amount
                                            :</label>
                                        <input type="text" class="form-control" placeholder="Ex, 123465"
                                            name="itemTotalPrice">
                                ...
                                <div class="col-12">
                                    <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                        <label class="lable1 text-end mx-2 mt-1 d-none d-md-inline" for=""
                                            style="width:300px;">Company Name:</label>
                                        <label class="lable2 text-start mx-2 mt-1  d-md-none " for="">Company
                                            Name
                                            :</label>
                                        <input type="text" class="form-control" placeholder="Ex, company name"
                                            name="scopeCompanyName">
                                    </div>
                                </div>
                                {{--  --}}
                            </div>
