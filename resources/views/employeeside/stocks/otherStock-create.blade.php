        ...
        <div class="card">
            <div class="card-header">
                <div class="col-12">
                    <div class="row">
                        <div class="col-6">
                            <a href="{{ route('otherItemsListIncludedParts') }}" class="btn btn-outline-primary"><i
            ...
            <div class="card-body">
                <h2 class="text-end d-none d-md-block">Create A New Stock ( Others )</h2>
                <h4 class="text-center d-md-none ">Create A New Stock ( Others )</h4>
                <form action="{{ route('newStockOtherOperation') }}" method="post" class="row"
                        ...
                        <div class="row px-2 py-2">
                            <div class="col-12">
                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                    ...
                                    <label class="lable2 text-start mx-2 mt-1  d-md-none " for="">Item
                                        Description
                                        :</label>
                                    <input type="text" class="form-control" placeholder="Ex, Washer , Light source"
                                        name="itemDetails">
                                </div>
                            </div>
                            {{--  --}}
                            ...
                            <div class="col-12">
                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                    ...
                                    <label class="lable2 text-start mx-2 mt-1  d-md-none " for="">Model Number
                                        :</label>
                            ...
                            <div class="col-12">
                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                    ...
                                    <label class="lable2 text-start mx-2 mt-1  d-md-none " for="">Company Name
                                        :</label>
                                    <input type="text" class="form-control" placeholder="Ex, demo company"
