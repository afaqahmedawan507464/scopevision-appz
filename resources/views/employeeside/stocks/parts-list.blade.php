...
<body>
    <div class="container mt-2">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('searchOtherItems') }}" method="post"
                ...
                <div class="col-12 py-2">
                    <div class="py-2 d-flex justify-content-end align-items-center">
                        <a href="{{ route('createNotificationsQtvCheckers') }}" class="btn btn-outline-primary"><i
                                            ...
                                            <div class="row py-2">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <span style="font-size: 12px;"><i class="mx-2 fas fa-calendar"></i>
                                                        <span mx-2>Incoming Date :
                                                            {{ $selectPart->item_incomingdate }}</span></span>
                                                    <br>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            <div class="d-flex justify-content-center align-items-center">
                                <div class="d-flex mx-1">
                                    <a href="{{ route('newStockScopesPartsPage') }}"
                                        class="btn btn-outline-primary">New
                                        Stock For Repairing Parts</a>
                                </div>
                                <div class="d-flex mx-1">
                                    <a href="{{ route('newStockOtherPage') }}" class="btn btn-outline-primary">New
                                        Stock
                                        For Other Items</a>
                                </div>
                            </div>
