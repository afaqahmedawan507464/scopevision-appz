        ...
        <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            @if (!empty($selectDatas->incoming_report_ids))
                                <h2 class="text-end d-none d-md-block">Edit Page for scopes</h2>
                                <h4 class="text-center d-md-none ">Edit Page for scopes</h4>
                            @else
                                @if (!empty($selectDatas->item_batchNo))
                                    <h2 class="text-end d-none d-md-block">Edit Page for disposible items</h2>
                                    <h4 class="text-center d-md-none ">Edit Page for disposible items</h4>
                                @else
                                    @if (!empty($selectDatas->item_companyname))
                                        <h2 class="text-end d-none d-md-block">Edit Page for others</h2>
                                        <h4 class="text-center d-md-none ">Edit Page for others</h4>
                                    @else
                                        <h2 class="text-end d-none d-md-block">Edit Page for parts</h2>
                                        <h4 class="text-center d-md-none ">Edit Page for parts</h4>
                                    @endif
                                @endif
                            @endif
                        </div>
            ...
            <div class="card-body">
                ...
                @else
                    ...
                    @endforeach
                    @if (!empty($selectDatas->incoming_report_ids))
                        <form action="{{ route('updateOperationStockScopesData', $selectDatas->id) }}" method="post"
                                    ...
                                    <div class="col-12">
                                        <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                            ...
                                            <input type="text" class="form-control" placeholder="Ex, Scope"
                                                name="itemDetails" value="{{ $selectDatas->item_name }}">
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="col-12">
                                        <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                            ...
                                            <label class="lable2 text-start mx-2 mt-1  d-md-none " for="">Price
                                                Per Unit
                                                :</label>
                                            <input type="text" class="form-control" placeholder="Ex, 123465"
                                                name="itemPricePerUnit" value="{{ $selectDatas->ratePerUnit }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                            ...
                                            <input type="text" class="form-control" placeholder="Ex, cf-140L"
                                                name="itemModel" value="{{ $selectDatas->item_scope_model }}">
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="col-12">
                    ...
                    @else
                        @if (!empty($selectDatas->item_batchNo))
                            <form action="{{ route('updateOperationStockDisposibleData', $selectDatas->id) }}"
                                ...
                                <div class="col-md-10 py-2 px-2">
                                    <div class="row px-2 py-2">
                                        <div class="col-12">
                                            <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                                <label class="lable1 text-end mx-2 mt-1 d-none d-md-inline"
                                                    for="" style="width:300px;">Item Name:</label>
                                                <label class="lable2 text-start mx-2 mt-1  d-md-none "
                                                    for="">Item Name
                                                    :</label>
                                                <input type="text" class="form-control"
                                                    placeholder="Ex, item name" name="itemDescription"
                                                    value="{{ $selectDatas->item_name }}">
                                            </div>
                                        </div>
                                        {{--  --}}
                                        <div class="col-12">
                                            <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                                <label class="lable1 text-end mx-2 mt-1 d-none d-md-inline"
                                                    for="" style="width:300px;">Price Per Unit:</label>
                                                <label class="lable2 text-start mx-2 mt-1  d-md-none "
                                                    for="">Price Per Unit
                                                    :</label>
                                                <input type="text" class="form-control" placeholder="Ex, 123465"
                                            ...
                                            <div class="col-12">
                                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Ex, 2mm"
                                                        name="itemSizes" value="{{ $selectDatas->size }}">
                                                </div>
                                            </div>
                                        @endif
                                        ...
                                        <div class="col-12">
                                            <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                                <label class="lable1 text-end mx-2 mt-1 d-none d-md-inline"
                                                    for="" style="width:300px;">Item Batch Number:</label>
                                                <label class="lable2 text-start mx-2 mt-1  d-md-none "
                                                    for="">Item Batch Number
                                                    :</label>
                                                <input type="text" class="form-control" placeholder="Ex, abc123"
                                                    name="itemBatchNo" value="{{ $selectDatas->item_batchNo }}">
                                            </div>
                                        </div>
                                        {{--  --}}
                                        <div class="col-12">
                                            <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                                <label class="lable1 text-end mx-2 mt-1 d-none d-md-inline"
                                                    for="" style="width:300px;">Item Expire Date:</label>
                                                <label class="lable2 text-start mx-2 mt-1  d-md-none "
                                                    for="">Item Expire Date
                                                    :</label>
                                                <input type="date" class="form-control"
                                                    placeholder="Ex, 0000 00 00" name="itemExpDate"
                                                    value="{{ $selectDatas->item_expDate }}">
                                            </div>
                                        </div>
                                        {{--  --}}
                                        <div class="col-12">
                                            <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                                ...
                                                <input type="date" class="form-control"
                                                    ...
                                                    value="{{ $selectDatas->item_incomingdate }}">
                                            </div>
                                        </div>
                                        {{--  --}}
                                        <script>
                        ...
                        @else
                            @if (!empty($selectDatas->item_companyname))
                                <form action="{{ route('updateOperationStockOtherData', $selectDatas->id) }}"
                                    method="post" class="row" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="col-md-10 py-2 px-2">
                                            ...
                                            <div class="col-12">
                                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                                    ...
                                                    <label class="lable2 text-start mx-2 mt-1  d-md-none "
                                                        ...
                                                        :</label>
                                                    <input type="text" class="form-control"
                                                        placeholder="Ex, 123465" name="itemPricePerUnit"
                                                        value="{{ $selectDatas->ratePerUnit }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                                    ...
                                                    <label class="lable2 text-start mx-2 mt-1  d-md-none "
                                                        ...
                                                        :</label>
                                                    <input type="text" class="form-control"
                                                        placeholder="Ex, 123465" name="itemQuantity"
                                                        value="{{ $selectDatas->item_qtv }}">
                                                </div>
                                            </div>
                                            {{--  --}}
                                            <div class="col-12">
                                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                                    ...
                                                    <label class="lable2 text-start mx-2 mt-1  d-md-none "
                                                        ...
                                                        :</label>
                                                    <input type="text" class="form-control"
                                                        placeholder="Ex, 12345678" name="itemSerialNo"
                                                        value="{{ $selectDatas->item_srno }}">
                                                </div>
                                            </div>
                                            {{--  --}}
                                            <div class="col-12">
                                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                                    ...
                                                    <label class="lable2 text-start mx-2 mt-1  d-md-none "
                                                        ...
                                                        :</label>
                                                    <input type="text" class="form-control"
                                                        placeholder="Ex, cf-140L" name="itemModel"
                                                        value="{{ $selectDatas->item_model }}">
                                                </div>
                                            </div>
                                            {{--  --}}
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ $selectDatas->item_companyname }}">
                                                </div>
                                            </div>
                                            {{--  --}}
                                            <script>
                                            ...
                                            <div class="col-12">
                                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                                    ...
                                                    <label class="lable2 text-start mx-2 mt-1  d-md-none "
                                                        ...
                                                        :</label>
                                                    <input type="text" class="form-control"
                                                        placeholder="Ex, 123465" name="itemTotalPrice">
                                                </div>
                                            </div>
                                            {{--  --}}
                                        </div>
                            ...
                            @else
                                <form action="{{ route('updateOperationStockScopesPartsData', $selectDatas->id) }}"
                                    method="post" class="row" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="col-md-10 py-2 px-2">
                                        <div class="row px-2 py-2">
                                            <div class="col-12">
                                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                                    ...
                                                    <textarea name="itemDescription" id="itemDescription" cols="30" rows="3" class="form-control"
                                                        placeholder="Ex, demo items">{{ $selectDatas->item_name }}</textarea>
                                                </div>
                                            </div>
                                            {{--  --}}
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        placeholder="Ex, 123465" name="itemQuantity"
                                                        name="itemDetails" value="{{ $selectDatas->item_qtv }}">
                                                </div>
                                            </div>
                                            {{--  --}}
                                            @if (empty($selectDatas->size))
                                                ...
                                                <div class="col-12">
                                                    <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                                        ...
                                                        <label class="lable2 text-start mx-2 mt-1  d-md-none "
                                                            ...
                                                            :</label>
                                                        <input type="text" class="form-control"
                                                            placeholder="Ex, 2mm" name="itemSizes" name="itemDetails"
                                                            value="{{ $selectDatas->size }}">
                                                    </div>
                                                </div>
                                            @endif
                                            {{--  --}}
                                            ...
                                            <div class="col-12">
                                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                                    ...
                                                    <label class="lable2 text-start mx-2 mt-1  d-md-none "
                                                        ...
                                                        :</label>
                                                    <input type="text" class="form-control"
                                                        placeholder="Ex, demo company" name="itemCompanyPartName"
                                                        value="{{ $selectDatas->part_companyname }}">
                                                </div>
                                            </div>
                                            {{--  --}}
                                            <script>
