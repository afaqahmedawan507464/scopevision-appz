    ...
    <div class="container mt-2">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('searchOperationServiceReport') }}" method="post"
                ...
                <div class="col-12 py-2">
                    <div class="py-2 d-flex justify-content-end align-items-center">
                        <a href="{{ route('pageCreateServiceReportPage') }}" class="btn btn-outline-primary"><i
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right"
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="{{ route('pageDetailServiceReportPage', $selectQuotation->id) }}"><i
