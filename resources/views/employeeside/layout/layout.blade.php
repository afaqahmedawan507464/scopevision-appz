              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="dashboard">
                    <li class="nav-item"><a class="nav-link" href="{{ route('attendanceEmployeesList') }}" aria-expanded="false">
                    ...
                    {{--  --}}
                    <li class="nav-item"><a class="nav-link" href="{{ route('holidayLeaveLists') }}" aria-expanded="false">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="dashboard17">
                    <li class="nav-item"><a class="nav-link" href="{{ route('employeeList') }}" aria-expanded="false">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="dashboard">
                    <li class="nav-item"><a class="nav-link" href="{{ route('stockDisposibleItemsList') }}" aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Stock Disposible Items List</span>
                        </div>
                      </a>
                      <!-- more inner pages-->
                    </li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('otherItemsListIncludedParts') }}" aria-expanded="false">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="dashboard1">
                    <li class="nav-item"><a class="nav-link" href="{{ route('pageDeliveryChallanListPage') }}" aria-expanded="false">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="dashboard2">
                    {{--  --}}
                    <li class="nav-item"><a class="nav-link" href="{{ route('detailsExpensesPagesss') }}" aria-expanded="false">
                  ...
                  {{--  --}}
                  <li class="nav-item"><a class="nav-link" href="{{ route('newOfficeExpensePage') }}" aria-expanded="false">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="dashboard3">
                    <li class="nav-item"><a class="nav-link" href="{{ route('listIncomingAndOutGoingDailyRecord') }}" aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Incoming And Outgoing Daily Report Scopes</span>
                        </div>
                      </a>
                      <!-- more inner pages-->
                    </li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('othersIncomingAndOutgoingDataDailyRecordList') }}" aria-expanded="false">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="dashboard4">
                    <li class="nav-item"><a class="nav-link" href="{{ route('withoutTjfScopeInspectionIncomingListPage') }}" aria-expanded="false">
                      <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Incoming Report List</span>
                      </div>
                    </a>
                    <!-- more inner pages-->
                  </li>
                  <li class="nav-item"><a class="nav-link" href="{{ route('withoutTjfScopesInspectionOutgoingListPage') }}" aria-expanded="false">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="dashboard7">
                    <li class="nav-item"><a class="nav-link" href="{{ route('pageInvoiceListPage') }}" aria-expanded="false">
                      <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Logo Invoice List</span>
                      </div>
                    </a>
                    <!-- more inner pages-->
                  </li>
                  <li class="nav-item"><a class="nav-link" href="{{ route('pageInvoiceListWithOutLogoPage') }}" aria-expanded="false">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="dashboard10">
                    <li class="nav-item"><a class="nav-link" href="{{ route('pageQuotationListPage') }}" aria-expanded="false">
                      <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Logo Quotation List</span>
                      </div>
                    </a>
                    <!-- more inner pages-->
                  </li>
                  <li class="nav-item"><a class="nav-link" href="{{ route('pageQuotationListWithOutLogoPage') }}" aria-expanded="false">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="dashboard13">
                    <li class="nav-item"><a class="nav-link" href="{{ route('pageServiceReportListPage') }}" aria-expanded="false">
            ...
            <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
              ...
              <li class="nav-item dropdown"><a class="nav-link pe-0" id="navbarDropdownUser" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                @if (empty(Auth::guard('employee')->user()->user_image))
                        ...
                        @else
                        <div class="avatar avatar-xl">
                          <img class="rounded-circle" src="{{Auth::guard('employee')->user()->user_image}}" alt="" />
                ...
                <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="navbarDropdownUser">
                  <div class="bg-white dark__bg-1000 rounded-2 py-2">
                    <a class="dropdown-item" href="{{ route('pageCreateAdminProfilePage') }}">Profile &amp; account</a>
                    <a class="dropdown-item" href="{{ route('logoutOperations') }}">Logout</a>
                  </div>
                </div>
              </li>
            </ul>
