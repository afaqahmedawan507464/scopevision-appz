        ...
        <div class="card">
            <div class="card-header">
                <div class="col-12">
                    <div class="row">
                        <div class="col-md-6">
                            <a href="{{ route('listIncomingAndOutGoingDailyRecord') }}"
            ...
            <div class="card-body">
                ...
                @if ($incomingInsppectionFormData->scope_tjf_elevator_channel == '')
                    {{-- gastro and colono --}}
                    <form action="{{ route('withoutTjfOutgoingInspectionCreatingOperation') }}" method="post"
                ...
                @else
                    {{-- tjf --}}
                    <form action="{{ route('TjfOutgoingInspectionCreatingOperation') }}" method="post"
                        class="row" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-10 py-2 px-2">
                            <div class="row px-2 py-2">
