        ...
        <div class="card">
            <div class="card-header">
                <div class="col-12">
                    <div class="row">
                        <div class="col-md-6">
                            <a href="{{ route('withoutTjfScopeInspectionIncomingListPage') }}"
            ...
            <div class="card-body">
                <h5 class="text-end d-none d-md-block">Incoming Inspection Report</h5>
                <h5 class="text-center d-md-none ">Incoming Inspection Report</h5>
                <form action="{{ route('TjfIncomingCreateInspectionOperation') }}" method="post" class="row"
