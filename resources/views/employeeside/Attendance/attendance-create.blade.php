        ...
        <div class="card">
            <div class="card-header">
                <div class="col-12">
                    <div class="row">
                        <div class="col-6">
                            <a href="{{ route('attendanceEmployeesList') }}" class="btn btn-outline-primary"><i
            ...
            <div class="card-body">
                <h2 class="text-end d-none d-md-block">Attendance Form</h2>
                <h4 class="text-center d-md-none ">Attendance Form</h4>
                <form action="{{ route('attendanceEmployeesCreationOperation') }}" method="post" class="row"
                    ...
                    <div class="col-md-10 py-2 px-2">
                        <div class="row px-2 py-2">
                                ...
                                <div class="col-12 d-none">
                                    <div class="d-flex justify-content-center align-items-center py-2">
                                        ...
                                        <input type="text" class="form-control" placeholder="Ex, demo client"
                                            name="companyTimeIn" value="{{ $selectCompanyDatas->companyTimeIn }}">
                                    </div>
                                </div>
                            @endif
                            {{--  --}}
                                    ...
                                    <select name="employeeId" id="employeeId" class="form-control">
                                        ...
                                        @else
                                            @foreach ($selectEmployees as $selectEmployeess)
                                                <option value="{{ $selectEmployeess->id }}">
                                                    {{ $selectEmployeess->employeename }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="col-12">
                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                    <label class="lable1 text-end mx-2 mt-1 d-none d-md-inline" for=""
                                        style="width:300px;">In Time:</label>
                                    <label class="lable2 text-start mx-2 mt-1  d-md-none " for="">
                                        In Time:</label>
                                    <input type="time" class="form-control" placeholder="Ex, 2024-02-06 13:50:09"
                                        name="clockInTime">
                                </div>
                            </div>
                            {{--  --}}
