...
<body>
    <div class="container mt-2">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('searchOperationQuotationss') }}" method="post"
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right"
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="{{ route('pageDetailWithOutLogoQuotationPage', $selectQuotation->id) }}"><i
                                                                        class="fas fa-user mx-2"></i> View Detail</a>
                                                                @if (\DB::table('invoices')->where('quotation_id', '=', $selectQuotation->id)->count() > 0)
                                                                @else
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('pageCreateInvoicePage', $selectQuotation->id) }}"><i
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-center align-items-center flex-wrap">
                        <div class="d-flex mx-1 my-1">
                            <a href="{{ route('pageCreateDisposibleQuotationPage') }}"
                                class="btn btn-outline-primary">Quotation For Disposible</a>
                        </div>
                        <div class="d-flex mx-1 my-1">
                            <a href="{{ route('pageCreateRepairingQuotationPage') }}"
                                class="btn btn-outline-primary">Quotation For System</a>
                        </div>
                        <div class="d-flex mx-1 my-1">
                            <a href="{{ route('pageCreateRepairingDataSS') }}"
                                class="btn btn-outline-primary">Quotation For Repairing</a>
                        </div>
                    </div>
                </div>
            </div>
