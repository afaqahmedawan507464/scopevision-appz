...
<body>
    <div class="container-fluid mt-2">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <h2 class="text-end d-none d-md-block">Leave List</h2>
                <h4 class="text-center d-md-none ">Leave List</h4>
                <div class="col-12 py-2">
                    <div class="py-2 d-flex justify-content-end align-items-center">
                        <a href="{{ route('createLeavePage') }}" class="btn btn-outline-primary"><i
