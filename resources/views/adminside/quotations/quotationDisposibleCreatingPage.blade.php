            ...
            <div class="card-header">
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <h2 class="text-end d-none d-md-block">Create New Quotation</h2>
                            <h4 class="text-center d-md-none ">Create New Quotation</h4>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ route('createQuotationDisposibleOperation') }}" method="post" class="row"
                    ...
                    <div class="col-md-10 py-2 px-2">
                        ...
                        {{--  --}}
                        <h5 class="text-start d-none d-md-block">Quotation Item Details</h5>
                        <h5 class="text-center d-md-none ">Quotation Item Details</h5>
                        {{--  --}}
                        <div id="add_form">
                            <div id="show_items4">
                                <div class="row px-2 py-2">
