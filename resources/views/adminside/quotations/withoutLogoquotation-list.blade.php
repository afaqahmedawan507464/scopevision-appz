...
<body>
    <div class="container mt-2">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('searchQuotationsWithOut') }}" method="post"
                    class="d-md-flex justify-content-center align-items-center">
                    @csrf
                    <input type="text" class="form-control mt-1 mt-md-0" id="searchQuotations"
                                            ...
                                            <div class="row py-2">
                                                <div class="col-12" style="padding-left: 90%;">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right" style="">
                                                        <a class="dropdown-item"
                                                            href="{{ route('detailWithOutLogoQuotationPage', $selectQuotation->id) }}"><i
                                                                class="fas fa-user mx-2"></i> View Detail</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('editPageQuotation', $selectQuotation->id) }}"><i
                                                                class="fas fa-edit mx-2"></i> Edit</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('removeQuotationPage', $selectQuotation->id) }}"><i
                                                                class="fas fa-trash mx-2"></i> Delete</a>
                                                        @if (\DB::table('invoices')->where('quotation_id', '=', $selectQuotation->id)->count() > 0)
                                                        @else
                                                            <a class="dropdown-item"
                                                                href="{{ route('createInvoicePage', $selectQuotation->id) }}"><i
                                                                    class="fas fa-file mx-2"></i> Create
                                                                Invoice</a>
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    ...
                                                    <span style="font-size: 12px;"><i class="mx-2 fas fa-box"></i>
                                                        <span mx-2>Reference :
                                                            {{ $selectQuotation->quotation_number }}</span></span>
                                                    <br>
                                                    <span style="font-size: 12px;"><i class="mx-2 fas fa-calendar"></i>
                                                        <span mx-2>Date :
                                                            {{ $selectQuotation->quotation_date }}</span></span>
                                                    <br>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-center align-items-center flex-wrap">
                        <div class="d-flex mx-1 my-1">
                            <a href="{{ route('createDisposibleQuotationPage') }}"
                                class="btn btn-outline-primary">Quotation For Disposible</a>
                        </div>
                        <div class="d-flex mx-1 my-1">
                            <a href="{{ route('createRepairingQuotationPage') }}"
                                class="btn btn-outline-primary">Quotation For System</a>
                        </div>
                        <div class="d-flex mx-1 my-1">
                            <a href="{{ route('createRepairingDataSS') }}" class="btn btn-outline-primary">Quotation
                                For Repairing</a>
                        </div>
                    </div>
                </div>
