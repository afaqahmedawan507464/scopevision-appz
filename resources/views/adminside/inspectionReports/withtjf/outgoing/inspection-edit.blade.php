        ...
        <div class="card">
            <div class="card-header">
                <div class="col-12">
                    <div class="row">
                        <div class="col-md-6">
                            <a href="{{ route('withoutTjfInspectionOutgoingListPage') }}"
            ...
            <div class="card-body">
                <h2 class="text-end d-none d-md-block">Edit Outgoing Inspection Report</h2>
                <h4 class="text-center d-md-none ">Edit Outgoing Inspection Report</h4>
                ...
                @if ($selectIncomingInspectionReport->scope_tjf_elevator_channel == '')
                    ...
                    <form
                        action="{{ route('updateWithoutTjfInspectionOutgoingReport', $selectIncomingInspectionReport->id) }}"
                                ...
                                <div class="col-12">
                                    <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                        ...
                                        <input type="text" class="form-control" placeholder="Ex, gif-140"
                                            name="scopeModel"
                                            value="{{ $selectIncomingInspectionReport->scope_model }}">
                                        <input type="text" class="form-control" placeholder="Ex, gif-140"
                                            name="companyId" value="{{ $selectIncomingInspectionReport->company_id }}"
                                            style="display: none">
                                    </div>
                                </div>
                                {{--  --}}
                                <div class="col-12">
                                    <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                        ...
                                        <input type="date" class="form-control" placeholder="Ex, 12-12-2023"
                                            ...
                                            value="{{ $selectIncomingInspectionReport->scope_incoming_date }}">
                                    </div>
                                </div>
                                {{--  --}}
                                <div class="col-12">
                                    <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                        ...
                                        <input type="number" class="form-control" placeholder="Ex, 123456789"
                                            name="scopeSrNumber"
                                            value="{{ $selectIncomingInspectionReport->scope_sr_number }}">
                                    </div>
                                </div>
                                {{--  --}}
                                <div class="col-12">
                                    <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                        ...
                                        <label class="lable2 text-start mx-2 mt-1  d-md-none " for="">Sender
                                            Name
                                            :</label>
                                        <input type="text" class="form-control" placeholder="Ex, Demo Person"
                                            name="scopeSenderName"
                                            value="{{ $selectIncomingInspectionReport->sender_name }}">
                                    </div>
                                </div>
                                {{--  --}}
                                <br>
                                ...
                                <div class="col-12">
                                    <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                        ...
                                        <textarea name="scopeReceivedWith" id="scopeReceivedWith" cols="30" rows="6" class="form-control"
                                            placeholder="Ex, Demo Data">{{ $selectIncomingInspectionReport->scope_sending_with }}</textarea>
                                    </div>
                                </div>
                                {{--  --}}
                                <br>
                                ...
                                <div class="col-12">
                                    <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                        ...
                                        <textarea name="scopeRemarks" id="scopeRemarks" cols="30" rows="10" class="form-control"
                                            placeholder="Ex, Describe Scope Fault And Your Remarks In Details">{{ $selectIncomingInspectionReport->remarks }}</textarea>
                                    </div>
                                </div>
                                {{--  --}}
                                {{--  --}}
                                    ...
                                    <div class="col-12">
                                        <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                            ...
                                            <select name="scopeInspectedBy" id="scopeInspectedBy"
                                                class="form-control">
                                                <option value="{{ $selectIncomingInspectionReport->inspectedby_id }}">
                                                    {{ $selectIncomingInspectionReport->employeename }}</option>
                ...
                @else
                    ...
                    <form
                        action="{{ route('updateTjfInspectionOutgoingCreatingOperation', $selectIncomingInspectionReport->id) }}"
                        method="post" class="row" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="col-md-10 py-2 px-2">
                            <div class="row px-2 py-2">
                                ...
                                <div class="col-12">
                                    <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                        ...
                                        <input type="text" class="form-control" placeholder="Ex, gif-140"
                                            name="companyId"
                                            value="{{ $selectIncomingInspectionReport->company_id }}"
                                            style="display: none">
                                    </div>
                                </div>
                                {{--  --}}
