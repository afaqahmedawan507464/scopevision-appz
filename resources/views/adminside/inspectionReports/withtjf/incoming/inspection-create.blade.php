...
<body>
    <div class="container mt-2">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <h2 class="text-end d-none d-md-block">Incoming Inspection Report</h2>
                <h4 class="text-center d-md-none ">Incoming Inspection Report</h4>
                <form action="{{ route('withoutTjfInspectionIncomingCreateOperation') }}" method="post" class="row"
                        ...
                        <div class="row px-2 py-2">
                            ...
                            <div class="col-12">
                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                    ...
                                    <label class="lable2 text-start mx-2 mt-1  d-md-none " for="">Scope Model
                                        :</label>
                                    <input type="text" class="form-control" placeholder="Ex, gif-140"
                                        name="scopeModel">
                                    <input type="text" class="form-control" placeholder="Ex, gif-140"
                                        name="companyId" value="{{ $companySelects->id }}" style="display: none">
                                </div>
                            </div>
                            {{--  --}}
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                    ...
                                    <label class="lable2 text-start mx-2 mt-1  d-md-none " for="">Sr Number
                                        :</label>
                            ...
                            <div class="col-12">
                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                    ...
                                    <textarea name="scopeReceivedWith" id="scopeReceivedWith" cols="30" rows="6" class="form-control"
                                        placeholder="Ex, Demo Data"></textarea>
                                </div>
                            </div>
                            {{--  --}}
                            <br>
                            ...
                            <div class="col-md-6">
                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                    ...
                                    <label class="lable2 text-start mx-2 mt-1  d-md-none " for="">Light Guide
                                        :</label>
                            ...
                            <div class="col-md-6">
                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                    ...
                                    <label class="lable2 text-start mx-2 mt-1  d-md-none " for="">Air/Water
                                        :</label>
                            ...
                            <div class="col-md-6">
                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                    ...
                                    <label class="lable2 text-start mx-2 mt-1  d-md-none " for="">Angulations
                                        :</label>
                            ...
                            <div class="col-md-6">
                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                    ...
                                    <label class="lable2 text-start mx-2 mt-1  d-md-none " for="">Insertion
                                        Tube
                                        :</label>
                            ...
                            <div class="col-md-6">
                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                    ...
                                    <label class="lable2 text-start mx-2 mt-1  d-md-none " for="">Objective
                                        Lenz
                                        :</label>
                            ...
                            <div class="col-md-6">
                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                    ...
                                    <label class="lable2 text-start mx-2 mt-1  d-md-none " for="">Angulation
                                        Lock
                                        :</label>
                            ...
                            <div class="col-12">
                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                    ...
                                    <textarea name="scopeRemarks" id="scopeRemarks" cols="30" rows="10" class="form-control"
                                        placeholder="Ex, Describe Scope Fault And Your Remarks In Details"></textarea>
                                </div>
                            </div>
                            {{--  --}}
                            <br>
