        ...
        <div class="card">
            <div class="card-header">
                <div class="col-12">
                    <div class="row">
                        <div class="col-md-6">
                            <a href="{{ route('withoutTjfInspectionIncomingListPage') }}"
            ...
            <div class="card-body">
                <h2 class="text-end d-none d-md-block">Edit Incoming Inspection Report</h2>
                <h4 class="text-center d-md-none ">Edit Incoming Inspection Report</h4>
                ...
                @if ($selectIncomingInspectionReport->scope_tjf_elevator_channel == '')
                    ...
                    <form
                        action="{{ route('updateWithoutTjfInspectionIncomingReport', $selectIncomingInspectionReport->id) }}"
                ...
                @else
                    ...
                    <form action="{{ route('TjfInspectionIncomingReport', $selectIncomingInspectionReport->id) }}"
                        method="post" class="row" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="col-md-10 py-2 px-2">
