            ...
            <div class="card-body">
                ...
                @if ($selectInvoicess->invoice_scope_model == '')
                    @if ($selectInvoicess->invoice_item_disposible_batchNo == '')
                        {{--  --}}
                        {{-- system items wala --}}
                        <form action="{{ route('createAccountHistorySystemOperation') }}" method="post" class="row"
                                    ...
                                    <h3 class="text-start d-none d-md-block">For System</h5>
                                        <h3 class="text-center d-md-none ">For System</h5>
                                            ...
                                            <div class="col-12">
                                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                                    <label class="lable1 text-end mx-2 mt-1 d-none d-md-inline"
                                                        for="" style="width:300px;">Invoice Date:</label>
                                                    <label class="lable2 text-start mx-2 mt-1  d-md-none "
                                                        for="">Invoice Date
                                                        :</label>
                                                    <input type="date" class="form-control"
                                                        placeholder="Ex, abc@abc.com" name="invoiceDate"
                                                        value="{{ $selectInvoicess->invoice_date }}">
                                                </div>
                                            </div>
                                            {{--  --}}
                                            @php
                    ...
                    @else
                        ...
                        <form action="{{ route('createAccountHistoryDisposibleOperations') }}" method="post"
                ...
                @else
                    ...
                    <form action="{{ route('createAccountHistoryRepairing_Operation') }}" method="post"
                        class="row" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-10 py-2 px-2">
                            <div class="row px-2 py-2">
