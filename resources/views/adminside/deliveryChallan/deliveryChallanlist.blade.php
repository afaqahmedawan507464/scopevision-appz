...
<body>
    <div class="container mt-2">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('searchDeliveryChallan') }}" method="post"
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right"
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="{{ route('detailDeleiveryChallanPage', $selectQuotation->id) }}"><i
                                                                        class="fas fa-user mx-2"></i> View Detail</a>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('editPageDeliveryChallan', $selectQuotation->id) }}"><i
                                                                        class="fas fa-edit mx-2"></i> Edit</a>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('removeOperationDeliveryChallan', $selectQuotation->id) }}"><i
                                                                        class="fas fa-trash mx-2"></i> Delete</a>
                                                                @if (\DB::table('stock_outgoings')->where('invoice_id', '=', $selectQuotation->invoice_id)->count() > 0)
                                                                @else
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('outgoingSystemDataStock', $selectQuotation->id) }}"><i
