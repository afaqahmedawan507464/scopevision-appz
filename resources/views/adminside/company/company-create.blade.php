...
<body>
    <div class="container mt-2">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('createComponyOperation') }}" method="post" class="row"
                    ...
                    <div class="col-10 py-2 px-2">
                        <div class="row px-2 py-2">
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-center align-items-center py-2">
                                    <label class="text-end mx-2 mt-1" for="" style="width:300px;">Company Owner
                                        Name:</label>
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-center align-items-center py-2">
                                    <label class="text-end mx-2 mt-1" for="" style="width:300px;">Company
                                        Timing ( To ):</label>
                                    <input type="time" class="form-control" placeholder="Ex, HH:MM:II"
                                        name="companyOpenTiming">
                                </div>
                            </div>
                            {{--  --}}
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-center align-items-start py-2">
                                    ...
                                    <textarea name="companyWorkInformation" id="companyWorkInformation" cols="30" rows="5"
                                        class="form-control" placeholder="Ex, Company Working Details"></textarea>
                                </div>
                            </div>
                            {{--  --}}
                        </div>
