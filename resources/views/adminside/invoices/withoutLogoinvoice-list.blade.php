            ...
            <div class="card-header">
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <h2 class="text-end d-none d-md-block">Invoice List (Without Logo)</h2>
                            <h4 class="text-center d-md-none ">Invoice List (Without Logo)</h4>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ route('searchInvoicess') }}" method="post"
                                                ...
                                                <div class="col-12" style="padding-left: 90%;">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right" style="">
                                                        <a class="dropdown-item"
                                                            href="{{ route('detailWithOutLogoInvoicePage', $selectQuotation->id) }}"><i
                                                                class="fas fa-user mx-2"></i> View Detail</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('editPageInvoice', $selectQuotation->id) }}"><i
                                                                class="fas fa-edit mx-2"></i> Edit</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('removeInvoicePage', $selectQuotation->id) }}"><i
                                                        ...
                                                        @else
                                                            ...
                                                            @else
                                                                ...
                                                                @else --}}
                                                                <a class="dropdown-item"
                                                                    href="{{ route('createDeliveryChallanPage', $selectQuotation->id) }}"><i
                                                        ...
                                                        @else
                                                            <a class="dropdown-item"
                                                                href="{{ route('createClientAccountHistoryPage', $selectQuotation->id) }}"><i
                                                        ...
                                                        @else
                                                            @if (\DB::table('invoices')->where('id', '=', $selectQuotation->id)->whereNotNull('invoice_item_disposible_batchNo')->count() > 0)
                                                                <a class="dropdown-item"
                                                                    href="{{ route('outgoingDataStock', $selectQuotation->id) }}"><i
