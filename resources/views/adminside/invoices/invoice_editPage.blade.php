            ...
            <div class="card-header">
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <h4 class="text-end d-none d-md-block">Edit Invoice</h4>
                            <h4 class="text-center d-md-none ">Edit Invoice</h4>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-body px-3 py-3">
                ...
                @if ($selectQuotations->invoice_scope_model == '')
                    @if ($selectQuotations->invoice_item_disposible_batchNo == '')
                        <form action="{{ route('editInvoiceRepairingOperation', $selectQuotations->id) }}"
                                        ...
                                        <div class="col-12 d-none">
                                            <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                                <label class="lable1 text-end mx-2 mt-1 d-none d-md-inline"
                                                    for="" style="width:300px;">Quotation Id:</label>
                                                <label class="lable2 text-start mx-2 mt-1  d-md-none "
                                                    for="">Quotation Id
                                                    :</label>
                                                <input type="text" class="form-control" placeholder="Ex, ABC123"
