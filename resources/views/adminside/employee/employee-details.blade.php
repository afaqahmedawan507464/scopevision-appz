        ...
        <div>
            <div>
                <div class="col-12">
                    <div class="row">
                        <div class="col-6">
                            <a href="{{ route('employeeNameList') }}" class="btn btn-outline-primary"><i
                                    class="fas fa-angle-left me-2"></i>Back</a>
                        </div>
                    </div>
                </div>
            </div>
            @foreach ($selectEmployeePage as $selectEmployees)
            @endforeach
            <div>
                <div class="row pt-3">
                    <div class="col-lg-4">
                            ...
                            <div class="card px-3 py-3">
                                <div class="d-flex justify-content-center align-items-center py-2">
                                    @if (!empty($selectEmployees->user_image))
                                        <img src="{{ $selectEmployees->user_image }}" alt=""
                                ...
                                @if ($selectEmployees->user_type == 'service eng')
                                    <span class="text-secondary text-center" style="font-size:15px;">Service
                                        Engineer</span>
                                ...
                                @elseif($selectEmployees->user_type == 'Engr')
                                    <span class="text-secondary text-center" style="font-size:15px;">Engineer</span>
                                @else
                                    <span class="text-secondary text-center" style="font-size:15px;">Computer
                                        Operator</span>
                                @endif
                            </div>
                        </div>
                                    ...
                                    @foreach ($selectSocials as $selectSocialss)
                                        @if (!empty($selectSocialss->facebook_account))
                                            <div class="d-flex justify-content-start align-items-center py-1">
                                                ...
                                                <span
                                                    style="font-size: 13px;">{{ $selectSocialss->facebook_account }}</span>
                                            </div>
                                        ...
                                        @if (!empty($selectSocialss->google_account))
                                            <div class="d-flex justify-content-start align-items-center py-1">
                                                ...
                                                <span
                                                    style="font-size: 13px;">{{ $selectSocialss->google_account }}</span>
                                            </div>
                                            <div class="border-dashed-bottom my-1"></div>
                                        @endif
                                        @if (!empty($selectSocialss->instagram_account))
                                            <div class="d-flex justify-content-start align-items-center py-1">
                                                ...
                                                <span
                                                    style="font-size: 13px;">{{ $selectSocialss->instagram_account }}</span>
                                            </div>
                                            <div class="border-dashed-bottom my-1"></div>
                                        @endif
                                        @if (!empty($selectSocialss->twitter_account))
                                            <div class="d-flex justify-content-start align-items-center py-1">
                                                ...
                                                <span
                                                    style="font-size: 13px;">{{ $selectSocialss->twitter_account }}</span>
                                            </div>
                                            <div class="border-dashed-bottom my-1"></div>
                                        @endif
                                        @if (!empty($selectSocialss->yahoo_account))
                                            <div class="d-flex justify-content-start align-items-center py-1">
                                                ...
                                                <span
                                                    style="font-size: 13px;">{{ $selectSocialss->yahoo_account }}</span>
                                            </div>
                                            <div class="border-dashed-bottom my-1"></div>
                                        @endif
                                        @if (!empty($selectSocialss->skype_account))
                                            <div class="d-flex justify-content-start align-items-center py-1">
                                                ...
                                                <span
                                                    style="font-size: 13px;">{{ $selectSocialss->skype_account }}</span>
                                            </div>
                                        @endif
                                    @endforeach
                                @endif
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex justify-content-start align-items-center py-1">
                                        ...
                                        <span class="mx-2">{{ $selectEmployees->employeeemailaddress }}</span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="d-flex justify-content-start align-items-center py-1">
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex justify-content-start align-items-center py-1">
                                        ...
                                        <span
                                            class="mx-2">{{ \Carbon\Carbon::parse($selectEmployees->date_of_birth)->format('M,d Y') }}</span>
                                    </div>
                                </div>
                                <div class="border-dashed-bottom my-1"></div>
                                <div class="col-md-6">
                                                ...
                                                @foreach ($educations as $educationss)
                                                    <tr>
                                                        <td style="width:33%;text-align:center;">
                                                            {{ $educationss->degree }}</td>
                                                        <td style="width:33%;text-align:center;">
                                                            {{ $educationss->subject }}</td>
                                                        <td style="width:33%;text-align:center;">
                                                            {{ $educationss->qualification_mode }}</td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
