...
<body>
    <div class="container mt-2">
        ...
        <div class="card">
            ...
            @endforeach
            <div class="card-body">
                <h2 class="text-end d-none d-md-block">Update Employee</h2>
                <h4 class="text-center d-md-none ">Update Employee</h4>
                <form action="{{ route('updateEmployeeOperation', $selectEmployees->id) }}" method="post"
                            ...
                            <div class="col-12">
                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                    ...
                                    <input type="text" class="form-control" placeholder="Ex, demo employee"
                                        name="employeeName" value="{{ $selectEmployees->employeename }}">
                                </div>
                            </div>
                            {{--  --}}
                            <div class="col-12">
                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                    ...
                                    <input type="email" class="form-control" placeholder="Ex, abc@abc.com"
                                        ...
                                        value="{{ $selectEmployees->employeeemailaddress }}">
                                </div>
                            </div>
                            {{--  --}}
                            <div class="col-12">
                                <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                    ...
                                    <label class="lable2 text-start mx-2 mt-1  d-md-none " for="">Employee Type
                                        :</label>
