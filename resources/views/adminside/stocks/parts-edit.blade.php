        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @else
                    ...
                    @endforeach
                    @if (!empty($selectDatas->incoming_report_ids))
                        <form action="{{ route('updateOperationStockScopes', $selectDatas->id) }}" method="post"
                    ...
                    @else
                        @if (!empty($selectDatas->item_batchNo))
                            <form action="{{ route('updateOperationStockDisposible', $selectDatas->id) }}"
                        ...
                        @else
                            @if (!empty($selectDatas->item_companyname))
                                <form action="{{ route('updateOperationStockOther', $selectDatas->id) }}"
                                    method="post" class="row" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="col-md-10 py-2 px-2">
                            ...
                            @else
                                <form action="{{ route('updateOperationStockScopesParts', $selectDatas->id) }}"
                                    method="post" class="row" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="col-md-10 py-2 px-2">
