...
<body>
    <div class="container mt-2">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('searchInvoices') }}" method="post"
                    ...
                    <div class="d-flex flex-md-row justify-content-center align-items-center">
                        ...
                        <input type="date" class="form-control mx-2" id="searchstartingDate"
                                ...
                                <div id="total_records">
                                    @foreach ($selectQuotations as $selectQuotation)
                                        <tr>
                                            ...
                                            <td style="width: 20%;text-align:center">
                                                <div class="d-flex">
                                                    <a href="{{ route('detailInvoicePage', $selectQuotation->id) }}"
                                                        id="clientDetails"
                                                        class="mx-1 text-decoration-none  btn btn-outline-primary "><i
                                                            class="fas fa-user"></i></a>
                                                    <a href="{{ route('editPageInvoice', $selectQuotation->id) }}"
                                                        id="clientEdit"
                                                        class="mx-1 text-decoration-none  btn btn-outline-warning "><i
                                                            class="fas fa-edit"></i></a>
                                                    <a href="{{ route('removeInvoicePage', $selectQuotation->id) }}"
                                                        class="mx-1 text-decoration-none  btn btn-outline-danger "><i
                                            ...
                                            @else --}}
                                                        ...
                                                        @else
                                                            ...
                                                            @else
                                                                <a href="{{ route('createDeliveryChallanPage', $selectQuotation->id) }}"
                                                                    class="mx-1 text-decoration-none  btn btn-outline-success "><i
                                                    ...
                                                    @else
                                                        <a href="{{ route('createClientAccountHistoryPage', $selectQuotation->id) }}"
                                                            class="mx-1 text-decoration-none  btn btn-outline-success "><i
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="d-flex justify-content-center align-items-center">
                            ...
                            <div class="d-flex mx-1">
                                <a href="{{ route('createRepairingDataSSInvoice') }}"
