        ...
        <div class="card">
            <div class="card-header">
                <div class="col-12">
                    <div class="row">
                        <div class="col-md-6">
                            <a href="{{ route('deliveryChallanListPage') }}" class="btn btn-outline-primary"><i
            ...
            <div class="card-body">
                ...
                @else
                    ...
                    @endforeach
                    <form action="{{ route('outgoingSystemItem') }}" method="post" class="row"
                        ...
                        @foreach ($quotation_item_srNumber as $key => $quotation_item_srNumbers) --}}
                                <div class="col-12 d-none">
                                    <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                        <label class="lable1 text-end mx-2 mt-1 d-none d-md-inline" for=""
                                            style="width:300px;">Item Id:</label>
                                        <label class="lable2 text-start mx-2 mt-1  d-md-none " for="">Item Id
                                            :</label>
                                        {{-- <label class="text-end mx-2 mt-1" for="" style="width:300px;">ItemId:</label> --}}
                                        <input type="text" class="form-control" placeholder="Ex, 123465"
                                            name="itemId" value="{{ $selectInvoiceDataas->item_id }}">
                                    </div>
                                </div>
                                {{--  --}}
                                <div class="col-12 d-none">
                                    <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                        ...
                                        {{-- <label class="text-end mx-2 mt-1" for=""
                                            style="width:300px;">Quantity:</label> --}}
                                        <input type="text" class="form-control" placeholder="Ex, 2mm" name="itemQtv"
                                            value="{{ $selectInvoiceDataas->delivery_challan_item_qtv }}">
                                    </div>
                                </div>
                                {{-- @endforeach --}}
                                {{--  --}}
                                <div class="col-12 d-none">
                                    <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                        ...
                                        <label class="lable2 text-start mx-2 mt-1  d-md-none " for="">Invoice Id
                                            :</label>
                                        {{-- <label class="text-end mx-2 mt-1" for=""
                                            style="width:300px;">InvoiceId:</label> --}}
                                        <input type="text" class="form-control" placeholder="Ex, 2mm"
                                            name="itemInvoiceId" value="{{ $selectInvoiceDataas->invoice_id }}">
                                    </div>
                                </div>
                                {{--  --}}
                                <div class="col-12">
                                    <div class="d-md-flex flex-md-row align-items-md-start py-2">
                                        ...
                                        <label class="lable2 text-start mx-2 mt-1  d-md-none " for="">Date
                                            :</label>
                                        <input type="date" class="form-control" placeholder="Ex, 2mm"
                                            name="itemOutgoingDate"
                                            value="{{ $selectInvoiceDataas->delivery_challan_date }}">
                                    </div>
                                </div>
                                {{--  --}}
                            </div>
